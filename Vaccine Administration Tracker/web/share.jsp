<%@ taglib uri="/WEB-INF/tlds/new" prefix="Vaccination" %>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">DISTRIBUTE VACCINE</h4>
          </li>
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              <p class="mb-0">Vaccine Inventory</p>
              <i class="typcn typcn-chevron-right"></i>
              <p class="mb-0">Distribute Vaccine</p>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav navbar-nav-right">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="view.jsp">
              ...
              <span class="menu-title">View Vaccines</span>
            </a>
             </li>
                <li class="nav-item">
            <a class="nav-link" href="share.jsp">
              <i class="typcn typcn-globe-outline menu-icon"></i>
              <span class="menu-title">Distribute Vaccines</span>
            </a>
          </li>
        </ul>
      </nav>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="distribute.jsp">
                     <div class="form-group">
                      <label for="exampleSelectGender">Name of Vaccine</label>
                        <select class="form-control" id="exampleSelectGender" name="id">
                          ...
                          <!-- tag that retuns the values of centres  -->
                      ...
                      <label for="exampleSelectGender">Health Centre</label>
                        <select class="form-control" id="exampleSelectGender" name="centre">
                          ...
                          <!-- tag that returns the values of selecting centre to distribute too -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail3" placeholder="Number" name="doses">
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        ...
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted">COVID-19 </span>
                    </div>
                </div>    
            </div>        
        </footer>
